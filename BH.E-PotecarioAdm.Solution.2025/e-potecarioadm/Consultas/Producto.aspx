<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Producto.aspx.cs" Inherits="BH.EPotecario.Adm.Consultas.Producto" %>
	    ...
	    $(function(){            
					$("#frmConsultaMail").validate({
						...
						messages: {
								...
								'<%=txtEmail.UniqueID%>': {
									required: "<br/>  * Tenés que ingresar un Email.", 
									email: "<br/> * Tenés que ingresar un Email correcto.",
									maxlength: "<br/>  * La cantidad máxima de caracteres a ingresar es 50."
								},
								'<%=txtOrden.UniqueID%>': {
...
<body>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
	    <tr>
	        <td style="width:340px">
	            <asp:Button ID="btnNuevo" runat="server" CssClass="cancel" Text="Nuevo Producto" OnClick="btnNuevo_Click" />
	        </td>
	        <td>
	            <asp:DropDownList ID="ddlProductos" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProductos_SelectedIndexChanged"></asp:DropDownList>
	        </td>
	    </tr>
	</table>
	<br />
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEmail" runat="server" Width="428px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
