<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmLicitacionesLETES.aspx.cs"
    Inherits="BH.EPotecario.Adm.Inversores.AdmLicitacionesLETES" %>
...
<head id="Head1" runat="server">
    ...
    <title>Banco Hipotecario - Simulador de Letes</title>
    ...
    <script type="text/javascript" src="../scripts/Js/InversoresLetes.js?v=20180413"></script>
    <link rel="stylesheet" href="../Content/Css/InversoresLetes.css?v=20180413" />
    <style type="text/css">
...
<body>
    <div id="Grid">
        ...
        <h1>Parametría calculador Letes</h1>
        <div class="div-admin">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <div class="row form-group col-xs-12">
                                        <tr>
                                            <td colspan="2" class="celdaCuadroInfo_Titulo">
                                                <b>LETES - Calendario de licitaciones</b>
                                            </td>
                                        </tr>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-sm-6 col-xs-12" style="margin-bottom: 20px">
                                            <asp:GridView ID="dgvCalendario" ClientIDMode="Static" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="IdCalendarioLicitacionesLETES" ItemStyle-CssClass="oculto"
                                                        HeaderStyle-CssClass="oculto" HeaderText="Id Calendario Licitaciones LETES" />
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6 col-xs-12" style="margin-bottom: 20px">
                                            <asp:GridView ID="dgvResultado" ClientIDMode="Static" runat="server" AutoGenerateColumns="False"
                                                CssClass="table table-striped table-hover table-condensed small-top-margin celdaCuadroInfo_Dato pl10 tablaCuadroInfo">
                                                <Columns>
                                                    <asp:BoundField DataField="IdResultadoUltimaLicitacionLETES" ItemStyle-CssClass="oculto"
                                                        HeaderStyle-CssClass="oculto" HeaderText="Id Resultado Ultima Licitación LETES" />
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group"><br /><br />
                                                <label>TNC MIN: </label> <input id="tncMin" runat="server" class="form-control" type="text" placeholder="TNC MIN"/>
                                                <label>TNC MAX: </label> <input id="tncMax" runat="server" class="form-control" type="text" placeholder="TNC MAX"/>
                                                <label>Tipo de cambio: </label> <input id="tipoCambio" runat="server" class="form-control" type="text" placeholder="Tipo de cambio"/>
                                            </div>
                                            <asp:Button id="btnActualizarTNC" runat="server" Text="Actualizar" Width="150px" Height="25px" BackColor="#003C5B" ForeColor="White" OnClick="btnActualizarTNC_Click" />
                                        </div>
                                    </div>
                                    <tr>
                                        <td class="labelErrores" colspan="2">
